...
mixin _$ExpenseModel {
 ...
 int? get id; int? get amount; String? get expenseType; String? get paymentRef; String? get notes; String? get ref;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,amount,expenseType,paymentRef,notes,ref);

@override
String toString() {
  return 'ExpenseModel(id: $id, amount: $amount, expenseType: $expenseType, paymentRef: $paymentRef, notes: $notes, ref: $ref)';
}
...
@useResult
$Res call({
 int? id, int? amount, String? expenseType, String? paymentRef, String? notes, String? ref
});
...
/// Create a copy of ExpenseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? amount = freezed,Object? expenseType = freezed,Object? paymentRef = freezed,Object? notes = freezed,Object? ref = freezed,}) {
  return _then(_self.copyWith(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,amount: freezed == amount ? _self.amount : amount // ignore: cast_nullable_to_non_nullable
as int?,expenseType: freezed == expenseType ? _self.expenseType : expenseType // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int? amount,  String? expenseType,  String? paymentRef,  String? notes,  String? ref)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExpenseModel() when $default != null:
return $default(_that.id,_that.amount,_that.expenseType,_that.paymentRef,_that.notes,_that.ref);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int? amount,  String? expenseType,  String? paymentRef,  String? notes,  String? ref)  $default,) {final _that = this;
switch (_that) {
case _ExpenseModel():
return $default(_that.id,_that.amount,_that.expenseType,_that.paymentRef,_that.notes,_that.ref);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int? amount,  String? expenseType,  String? paymentRef,  String? notes,  String? ref)?  $default,) {final _that = this;
switch (_that) {
case _ExpenseModel() when $default != null:
return $default(_that.id,_that.amount,_that.expenseType,_that.paymentRef,_that.notes,_that.ref);case _:
  return null;
...
class _ExpenseModel implements ExpenseModel {
   _ExpenseModel({this.id, this.amount, this.expenseType, this.paymentRef, this.notes, this.ref});
...
/// Create a copy of ExpenseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? amount = freezed,Object? expenseType = freezed,Object? paymentRef = freezed,Object? notes = freezed,Object? ref = freezed,}) {
